...
Created Average Order Value metric
Exported cleaned dataset as CSV for Tableau
...
Total Customers
Visualizations
Monthly Customer Segment Distribution
...
Average Order Value: ₹502.4
Champions are the highest-value customer segment.
...
https://public.tableau.com/views/customertrensandinsights/Dashboard3?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link
